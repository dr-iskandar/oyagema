    ...
    <MainLayout>
      <div className="space-y-8">
        <header className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-text-primary mb-2">Your Library</h1>
            <p className="text-lg text-text-secondary">
              Access your personal collection of spiritual music and listening history.
            </p>
          </div>
        </header>

        <section aria-labelledby="library-tabs">
          <div className="mb-8">
            ...
            {isLoading && (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-text-secondary">Loading your library...</p>
              </div>
            )}
            ...
            {hasError && (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-text-secondary">We couldn&apos;t load your library. Please try again later.</p>
              </div>
            )}

            {/* History tab */}
            {activeTab === 'history' && !isLoading && !hasError && (
              <section aria-labelledby="recently-played" className="bg-background-light/30 rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h2 id="recently-played" className="text-xl font-bold text-text-primary">Recently Played</h2>
                      <p className="text-text-secondary text-sm">Your spiritual music listening history</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 space-y-1">
                  {history && history.length > 0 ? (
                    ...
                    <div className="text-center py-8 text-text-secondary">
                      ...
                      <p className="text-sm mt-2">Start exploring spiritual music to build your personal library</p>
                    </div>
                  )}
                </div>
              </section>
