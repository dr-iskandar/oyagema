      ...
      <div className="space-y-8">
        <header className="mb-6">
          ...
          <p className="text-lg text-text-secondary">
            Manage your account settings and personal information for your spiritual music journey.
          </p>
        </header>
            ...
            <div className="flex-1">
              {isEditing ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="password" className="block text-text-secondary mb-1">New Password (leave blank to keep current)</label>
                    <div className="relative">
                      <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-text-secondary">
                        <FiLock />
                      </span>
                  ...
                  <div>
                    <label htmlFor="confirmPassword" className="block text-text-secondary mb-1">Confirm New Password</label>
                    <div className="relative">
                      <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-text-secondary">
                        <FiLock />
                      </span>
                ...
                <div>
                  <h2 id="profile-info" className="text-3xl font-bold text-text-primary mb-2">{user.name}</h2>
                  <p className="text-text-secondary mb-6">{user.email}</p>
                  <p className="text-text-muted text-sm">
                    Manage your spiritual music preferences and account settings to enhance your mindfulness journey.
                  </p>
                </div>
              )}
            </div>
