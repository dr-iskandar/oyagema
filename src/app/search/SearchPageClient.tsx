    ...
    <GuestLayout>
      <div className="space-y-8">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-text-primary mb-6">Search Spiritual Music</h1>
          <p className="text-lg text-text-secondary mb-6">
            Discover healing music, meditation tracks, and spiritual content for your mindfulness journey.
          </p>
        ...
        <section aria-labelledby="browse-by-mood">
          <h2 id="browse-by-mood" className="text-xl font-semibold text-text-primary mb-4">Browse by Mood</h2>
        ...
        {filteredCategories.length > 0 && (
          <section aria-labelledby="search-categories">
            <h2 id="search-categories" className="text-2xl font-bold text-text-primary mb-6">
              {searchQuery ? 'Categories' : 'Browse Categories'}
            </h2>
            <CategoryGrid
              title="Categories"
        ...
        {filteredTracks.length > 0 && (
          <section aria-labelledby="search-tracks">
            <h2 id="search-tracks" className="text-2xl font-bold text-text-primary mb-6">
              {searchQuery ? 'Tracks' : 'All Tracks'}
            </h2>
            <TrackGrid
              title="Tracks"
        ...
        {!searchQuery && filteredTracks.length === 0 && filteredCategories.length === 0 && (
          <div className="text-center py-12">
            <h3 className="text-xl text-text-secondary mb-4">Start your spiritual music journey</h3>
            <p className="text-text-muted">Search for healing music, meditation tracks, or browse by categories above.</p>
          </div>
        )}
      </div>
    </GuestLayout>
