  ...
  return (
    <GuestLayout>
      <div className="space-y-8">
        {/* Category Header */}
        <header>
          <h1 className="sr-only">{category.title} - Spiritual Music Category</h1>
          <motion.div 
          ...
          >
            <Image 
              ...
              alt={`${category.title} spiritual music category cover`} 
              fill 
        ...
        {/* Category Tracks */}
        <section aria-labelledby="category-tracks">
          <h3 id="category-tracks" className="text-2xl font-bold text-text-primary mb-6">
            Tracks in {category.title}
          </h3>
          {category.tracks && category.tracks.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-xl text-text-secondary">No tracks available in this category yet.</p>
            </div>
          )}
        </section>
      </div>
