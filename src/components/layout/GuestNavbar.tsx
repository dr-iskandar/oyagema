...
import { FiUser, FiLogOut, FiHeart, FiLogIn } from 'react-icons/fi';
    ...
    <nav className="fixed top-0 right-0 z-[60] p-4">
      <div className="flex items-center space-x-3">
        ...
        {isAuthenticated && user ? (
          ...
          <button 
            onClick={handleLogin}
            className="flex items-center space-x-2 px-4 py-2 rounded-full bg-primary hover:bg-primary-dark transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            <FiLogIn className="text-white" size={16} />
